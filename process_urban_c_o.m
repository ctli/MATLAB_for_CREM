...
hb0 = bar(yr-0.5, [urb_c_n; urb_o_n; urb_o_b']', 0.3, 'stacked', 'edge', 'none', 'linewidth', 2);
...
hb1 = bar(yr-0.5, sum([urb_c_n; urb_o_n; urb_o_b']), 0.3, 'stacked', 'facec', 'none', 'edge', [0.5 0.5 0.5], 'linewidth', 2);
...
xlim([2005 2031.5]);
legend(fliplr(hb0), 'Biomass Burning', 'Industrial Process', 'Fossil Fuel Combustion', 2);
...
hb0 = bar(yr+0.5, [urb_c_n; urb_o_n; urb_o_b']', 0.3, 'stacked', 'edge', 'none', 'linewidth', 2);
set(hb0(1), 'facec', [0.5 0 0]); %biomass burning
hb1 = bar(yr+0.5, sum([urb_c_n; urb_o_n; urb_o_b']), 0.3, 'stacked', 'facec', 'none', 'edge', 'b', 'linewidth', 2);

if i == 1
    text(2010, 3.1, 'Gray: No Policy; ', 'fontsize', 8, 'color', [0.5 0.5 0.5]);
    text(2017.5, 3.1, 'Blue: Rgnl CO2 Cap', 'fontsize', 8, 'color', 'b');
end
