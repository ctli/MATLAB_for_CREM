...
gdx_filename = 'result_coaltax.gdx';
...
legend('No Policy', 'Coal Tax in 3 Key Regions', 3);
...
text(yr(1)+dx, sum(tmp(1,:))+100, 'Right: Coal Tax in 3 Key Regions', 'fontsize', 6, 'rotation', 90, 'color', 'r');
...
set(gca, 'yminortick', 'on', 'xminortick', 'on');
set(gca, 'pos', [0.08    0.6875    0.75    0.25]);
title('Regional Coal Consumption (mtce) (Coal Tax in 3 Key Regions)');
my_gridline;
...
set(gca, 'xminortick', 'on');
set(gca, 'pos', [0.08    0.6875    0.75    0.25]);
title('Regional Coal Share (Coal Tax in 3 Key Regions)');
my_gridline;
...
legend('No Policy', 'Coal Tax in 3 Key Regions', 2, 'orientation', 'horizontal');
